...
assert.equal(api.countsTowardProfileFastMode({ source: "codex-session", fastMode: null }), false);
assert.equal(api.countsTowardProfileFastMode({ source: "codex-session", fastMode: false }), true);
assert.equal(api.countsTowardProfileFastMode({ source: "codex-live-token-cost", fastMode: null }), true);
